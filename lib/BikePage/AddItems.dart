    ...
    return Padding(
      ...
      child: Column(
        children: [
          const Row(
            children: [
              Text("Add ",style: TextStyle(fontWeight: FontWeight.bold,fontSize: 21)),Text("items",style: TextStyle(fontSize: 21),)
            ],
          ),
          SizedBox(height: 18,),
          Padding(
    ...
    child: Row(
      ...
      children: [
        Row(children: [
          ...
          Image(image: AssetImage(item.img),height: 35,width: 45,),
          Padding(
            padding: const EdgeInsets.only(left: 10),
            child: Column(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                Text(item.title,style: const TextStyle(fontSize: 18,fontWeight: FontWeight.w700,color: Colors.black),),
                Row(
                  children: [
                    Text(item.price,style: const TextStyle(fontSize: 18,fontWeight: FontWeight.w400,color: Colors.black),),
